...
#define PID_MAX 255 // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  #define PID_FUNCTIONAL_RANGE 3 // If the temperature difference between the target temperature and the actual temperature            era 10
...
//    You must specify the X & Y coordinates of all 3 points
  ...
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -1.2//-2.3
...
#define HOMING_FEEDRATE {6000, 6000, 300, 0}  // set the homing speeds (mm/min)

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {79.78, 79.78, 3200.00 , 87.05}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {250, 250, 10, 25}   // (mm/sec)
...
#define DEFAULT_EJERK                 8.5    // (mm/sec)  5 - 8
